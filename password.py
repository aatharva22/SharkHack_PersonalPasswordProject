...
class Password:
    ...
    def __init__(self, word_1: str, word_2: str, word_3: Optional[str] = None, word_4: Optional[str] = None, word_5: Optional[str] = None, separator: str = "_", convert: Optional[str] = None):
        '''
    ...
    def randomize_password(self, word: str) -> str:
        ...
        if length != 0:
            ...
            randomized = "PASSWORD CAN'T BE EMPTY"
        return randomized
...
def main() -> None:
    ...
    convert = input("Input anything to convert common characters: ") or None

    P = Password(word_1,word_2,word_3,word_4,word_5, separator, convert)
    ...
    hack_check = P.mock_attack(randomized)
    print(hack_check)
